...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        WorkJsonWithLocal local = new WorkJsonWithLocal();
        WorkJsonWithServer server = new WorkJsonWithServer();
    ...
    public static void run(ItemsStore itemsStore){
        do {
            System.out.println("Что вы хотите сделать?\n " +
                    "1-получение, 2-добавление, 3-редактирование, 4-удаление, 5-получить все, 6-закончить");
